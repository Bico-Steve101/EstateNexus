    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='User.manager')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('payment_id', models.CharField(editable=False, max_length=5, unique=True)),
